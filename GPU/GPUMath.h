...
static __device__ __forceinline__
void _ShiftR62(uint64_t dest[5], const uint64_t r[5], uint64_t carry)
{
...
__device__ void _IMult(uint64_t *r, const uint64_t *a, int64_t b)
{
...
__device__ uint64_t _IMultC(uint64_t *r, const uint64_t *a, int64_t b)
{
...
static __device__ __forceinline__
void _MulP(uint64_t * __restrict__ r, uint64_t a)
{
...
static __device__ __forceinline__
void _ModNeg256(uint64_t * __restrict__ r, const uint64_t * __restrict__ a)
{
...
static __device__ __forceinline__
void _ModNeg256(uint64_t * __restrict__ r)
{
...
static __device__ __forceinline__
void _ModAdd256(uint64_t * __restrict__ r,
                ...
                const uint64_t * __restrict__ b)
{
    ...
    uint64_t rr[5] = { t0, t1, t2, t3, t4 };

    SubP(rr);

    if(_IsPositive(rr)) {
        Load256(r, rr); // copy limbs 0‑3
    }
...
static __device__ __forceinline__
void _ModSub256(uint64_t *r, const uint64_t* __restrict__ a, const uint64_t* __restrict__ b)
{
    uint64_t t;
    uint64_t T[4];
...
// ---------------------------------------------------------------------------------------
static __device__ __forceinline__
void _ModSub256(uint64_t * __restrict__ r, const uint64_t * __restrict__ b)
{
...
static __device__ __forceinline__
uint64_t _AddCh(uint64_t r[5], const uint64_t a[5], uint64_t carry)
{
...
// ---------------------------------------------------------------------------------------
static __device__ __forceinline__
void _ModMult(uint64_t *r, const uint64_t* __restrict__ a, const uint64_t* __restrict__ b)
{
...
static __device__ __forceinline__
void _ModMult(uint64_t *r, const uint64_t* __restrict__ a)
{
...
static __device__ __forceinline__
void _ModSqr(uint64_t * __restrict__ rp, const uint64_t * __restrict__ up)
{
...
__device__ int _BinarySearch(const uint64_t *buffer, int hi, uint64_t target)   // unchanged semantics
{
    int mid;
	int lo = 0;
...
static __device__ __forceinline__
void _PointAddSecp256k1(uint64_t * __restrict__ p1x,
                        uint64_t *__restrict__ p1y,
                        uint64_t *__restrict__ p1z,
                        uint64_t *__restrict__ p2x,
                        uint64_t *__restrict__ p2y)
{
  /* all scratch arrays exposed as restrict pointers                       */
  uint64_t u_buf[4],  v_buf[4];
  uint64_t __restrict__ *u = u_buf;
  uint64_t __restrict__ *v = v_buf;

  uint64_t us2_buf[4], vs2_buf[4], vs3_buf[4], a_buf[4];
  uint64_t __restrict__ *us2 = us2_buf;
  uint64_t __restrict__ *vs2 = vs2_buf;
  uint64_t __restrict__ *vs3 = vs3_buf;
  uint64_t __restrict__ *a   = a_buf;

  uint64_t us2w_buf[4], vs2v2_buf[4], vs3u2_buf[4], _2vs2v2_buf[4];
  uint64_t __restrict__ *us2w   = us2w_buf;
  uint64_t __restrict__ *vs2v2  = vs2v2_buf;
  uint64_t __restrict__ *vs3u2  = vs3u2_buf;
  uint64_t __restrict__ *_2vs2v2 = _2vs2v2_buf;
